$(function(){
    layui.use('table', function() {
        ...
        layui.table.render({
            ...
            even: ape_even,
            cols:  [ape_cols],
            url: '/index/service/itemorderbill_list',
            page: true,
...
function export_data() {
    ...
    alert_info('稍等，数据请求中', "/index/export/itemorder_bill?" + url_info,true);
}
//报表
        ...
        layer.ready(function() {
            var index = layer.open({
                ...
                success: function(layero, index) {
                    ...
                    //弹出后回调
                    $.post("/index/service/itemorderbill_info", {
                        "id": id,
                    }, function(re) {
                ...
                btn1: function(layero) {
                    ...
                    if(!regular_price.test(sum) || sum==="0"){
                        ...
                        $.post("/index/service/save_itemorderbill", {
                            "id": id,
                            "account": account,
                            "sum": sum,
                            "data": data
    ...
    if(auth_type){
        layui.use('layer', function() {
            layer.confirm('删除后资金将归还到原先账户，确定操作？', {
                ...
                $.post("/index/service/del_itemorderbill", {
                    "id": id
                }, function(re) {
                    if (re === "success") {
                        re_alert('删除成功!');
