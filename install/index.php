...
<html>
	...
	<body>
		<div class="top">
			<div class="topcont">
				<div class="logo">
					<a href="https://www.nodcloud.com/" target="_blank"><img src="images/logo.png" alt="APE进销存管理系统" /></a>
				</div>
				<div class="headright">APE进销存管理系统 <font>V5.0.4</font></div>
				<div class="clear"></div>
			</div>
		</div>
		<div class="body">
			<div class="bodycont">
				...
				<div class="foot">APE进销存软件受《中华人民共和国著作权法》保护，著作权号（2017SR609645）,版权所有，盗版必究！</div>
			</div>
		</div>
	</body>
</html>